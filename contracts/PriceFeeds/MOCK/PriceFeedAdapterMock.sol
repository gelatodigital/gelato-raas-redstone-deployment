...
contract PriceFeedAdapterMock is PriceFeedsAdapterWithoutRounds {

  bytes32 constant private MOCK_ID = bytes32("MOCK");
  ...
  function getDataFeedIndex(bytes32 dataFeedId) public view override virtual returns (uint256) {
    if (dataFeedId == MOCK_ID) { return 0; }
